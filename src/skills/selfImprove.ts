...
- If the user asks you to "sync" or "push the plugin", commit the changes and push to the appropriate remote. Never push vault-level files (session data, \`community-plugins.json\`, agent-vault notes, other plugins) to a public plugin repository.
